    ...
    return (
        <Center padding={2}>
            <SimpleGrid minChildWidth={'120px'} minWidth={'240px'} maxWidth={'600px'} spacing={5}>
                <Box height='170px' align={"center"}>
                    <Image
                        src="/image/aws_ccp.png"
                        boxSize={'110px'} />
